...
module.exports = Gemini = (function() {
  ...
  Gemini.prototype.withdraw = function(withdraw_type, walletselected, amount, address, cb) {
    var params;
    params = {
  ...
  Gemini.prototype.transfer = function(amount, currency, walletfrom, walletto, cb) {
    var params;
    params = {
      amount: amount,
      currency: currency,
